...
impl Default for FlagStand {
    fn default() -> Self {
        ...
        let superclass = BasePart {
            ...
            CollisionGroupId: 0i32,
            Color: Color3uint8::new(163u8, 162u8, 165u8).into(),
            CustomPhysicalProperties: PhysicalProperties::Default,
    ...
    fn default() -> Self {
        ...
        let superclass = Instance {
            ...
            Attributes: Attributes::from_iter([
                ("RBX_BackupBrightness".to_owned(), 1f32.into()),
                ("RBX_BackupExposureCompensation".to_owned(), 0f32.into()),
                ("RBX_LightingCompatibilityMigrated".to_owned(), true.into()),
                (
                    "RBX_LightingTechnologyUnifiedMigration".to_owned(),
                    true.into(),
                ),
                ("RBX_OriginalTechnologyOnFileLoad".to_owned(), 2i32.into()),
            ]),
            Capabilities: SecurityCapabilities::from_bits(0u64),
            HistoryId: UniqueId::nil(),
            Name: "".to_owned(),
...
impl Default for NegateOperation {
    fn default() -> Self {
        ...
        let superclass = BasePart {
            ...
            CollisionGroup: "Default".to_owned(),
            CollisionGroupId: 0i32,
            Color: Color3uint8::new(255u8, 255u8, 255u8).into(),
            CustomPhysicalProperties: PhysicalProperties::Default,
            EnableFluidForces: true,
            FrontParamA: -0.5f32,
            FrontParamB: 0.5f32,
